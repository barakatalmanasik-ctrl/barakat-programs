  ...
  container.innerHTML = `
    <div class="detail-page">
      ...
      <div class="detail-page__booking-bar">
        ...
        <div class="detail-page__booking-actions">
          <button class="detail-page__booking-btn detail-page__booking-btn--whatsapp" onclick="openWhatsAppBooking('${program.id}')" ${program.status === 'full' ? 'disabled' : ''}>
            ...
            <span>${program.status === 'full' ? 'مكتمل' : 'احجز عبر WhatsApp'}</span>
          </button>
          ${program.status !== 'full' ? `
          <button class="detail-page__booking-btn detail-page__booking-btn--outline" onclick="openWhatsAppInquiry('${program.id}')">
            استفسر عبر WhatsApp
          </button>
          ` : ''}
        </div>
